...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/ATKit_Swift/ATKit_Swift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ATRefresh_Swift/ATRefresh_Swift.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MGJRouter_Swift/MGJRouter_Swift.framework"
